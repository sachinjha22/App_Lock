...
import static com.karmakarin.safebox.support.patterns.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static com.karmakarin.safebox.support.patterns.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static com.karmakarin.safebox.support.patterns.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static com.karmakarin.safebox.support.patterns.PatternLockView.PatternViewMode.AUTO_DRAW;
import static com.karmakarin.safebox.support.patterns.PatternLockView.PatternViewMode.CORRECT;
import static com.karmakarin.safebox.support.patterns.PatternLockView.PatternViewMode.WRONG;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mPathWidth = (int) typedArray.getDimension(R.styleable.PatternLockView_pathWidth,
                    ResourceUtils.getDimensionInPx(getContext(), R.dimen.dp3));
            mNormalStateColor = typedArray.getColor(R.styleable.PatternLockView_normalStateColor,
                    ResourceUtils.getColor(getContext(), R.color.off_white));
